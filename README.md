...
- [Portable app](https://github.com/IJustItay/Neon-Equalizer/releases/latest/download/Neon-Equalizer-2.0.6-Portable.exe) - run without installing.
- [Installer](https://github.com/IJustItay/Neon-Equalizer/releases/latest/download/Neon-Equalizer-2.0.6-Setup.exe) - guided installation with shortcuts.
...
The outputs are written to `release/Neon-Equalizer-2.0.6-Portable.exe` and `release/Neon-Equalizer-2.0.6-Setup.exe`.
